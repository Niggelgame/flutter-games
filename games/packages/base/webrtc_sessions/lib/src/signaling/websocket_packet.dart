...
class ServerHelloPacket {
  ...
  ServerHelloPacket(
      this.isServer, this.game, this.selfId, this.name, this.gameConfig);
...
class SessionCandidate {
  ...
  factory SessionCandidate.fromJson(Map<String, dynamic> json) =>
      _$SessionCandidateFromJson(json);
...
class CandidatePacket {
  ...
  factory CandidatePacket.fromJson(Map<String, dynamic> json) =>
      _$CandidatePacketFromJson(json);
...
class ByebyePacket {
  ...
  factory ByebyePacket.fromJson(Map<String, dynamic> json) =>
      _$ByebyePacketFromJson(json);
...
class OfferAnswerPacket {
  ...
  factory OfferAnswerPacket.fromJson(Map<String, dynamic> json) =>
      _$OfferAnswerPacketFromJson(json);
...
class PassThroughPacket<T> {
  ...
  factory PassThroughPacket.fromJson(Map<String, dynamic> json) =>
      _$PassThroughPacketFromJson(json);
