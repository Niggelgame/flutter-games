...
class SessionHandler<
  ...
  addSession(SingleSessionHandler<PlayerGameEvent, ServerGameEvent> session,
      String peerName, bool isAdmin) {
    _sessions[session.sessionId] = session;
    final p = Player<PlayerGameEvent, ServerGameEvent, G>(
        session, server, peerName, isAdmin);
    server.onJoin(p);
  }
